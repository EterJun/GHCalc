...
tab4_cold_label.grid(row=14, column=0, padx=10, pady=1, sticky=tk.W)
tab4_colc_entry = tk.Entry(tab4, width=10)
tab4_colc_entry.grid(row=14, column=1, padx=10, pady=1, sticky=tk.W)



tab4_col001_label = tk.Label(tab4, text="作业")
tab4_col001_label.grid(row=1, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col011_label = tk.Label(tab4, text="时间（分钟）")
tab4_col011_label.grid(row=1, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col11_label = tk.Label(tab4, text="C廊桥检查及准备工作完成时间", wraplength=140, justify="left")
tab4_col11_label.grid(row=2, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col11_entry = tk.Entry(tab4, width=10)
tab4_col11_entry.grid(row=2, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col11_entry.insert(0, 0)
tab4_col12_label = tk.Label(tab4, text="C航后航班申请拖曳时间", wraplength=140, justify="left")
tab4_col12_label.grid(row=3, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col12_entry = tk.Entry(tab4, width=10)
tab4_col12_entry.grid(row=3, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col12_entry.insert(0, 0)
tab4_col13_label = tk.Label(tab4, text="D机务给对接指令→廊桥对接", wraplength=140, justify="left")
tab4_col13_label.grid(row=4, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col13_entry = tk.Entry(tab4, width=10)
tab4_col13_entry.grid(row=4, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col14_label = tk.Label(tab4, text="D机务给对接指令→客梯车对接", wraplength=140, justify="left")
tab4_col14_label.grid(row=5, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col14_entry = tk.Entry(tab4, width=10)
tab4_col14_entry.grid(row=5, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col15_label = tk.Label(tab4, text="D选择指令对接评分指标")
tab4_col15_label.grid(row=6, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
...
tab4_combobox3.grid(row=6, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col16_label = tk.Label(tab4, text="D廊桥对接完成→开启客舱门", wraplength=140, justify="left")
tab4_col16_label.grid(row=7, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col16_entry = tk.Entry(tab4, width=10)
tab4_col16_entry.grid(row=7, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col17_label = tk.Label(tab4, text="D客梯车对接完成→开启客舱门", wraplength=140, justify="left")
tab4_col17_label.grid(row=8, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col17_entry = tk.Entry(tab4, width=10)
tab4_col17_entry.grid(row=8, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col18_label = tk.Label(tab4, text="D选择对接开舱门评分指标", wraplength=140, justify="left")
tab4_col18_label.grid(row=9, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col18_entry = tk.StringVar(value="廊桥")
tab4_combobox3 = ttk.Combobox(tab4, textvariable=tab4_col18_entry, values=["廊桥", "客梯车"], state="readonly", width=5)
tab4_combobox3["style"] = "TCombobox"
tab4_combobox3.grid(row=9, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col19_label = tk.Label(tab4, text="D接到指令→推离机位", wraplength=140, justify="left")
tab4_col19_label.grid(row=10, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col19_entry = tk.Entry(tab4, width=10)
tab4_col19_entry.insert(0, 0)
tab4_col19_entry.grid(row=10, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col1a_label = tk.Label(tab4, text="航空器机型", wraplength=140, justify="left")
tab4_col1a_label.grid(row=11, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col1a_entry = tk.Entry(tab4, width=10)
tab4_col1a_entry.grid(row=11, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col1a_entry.insert(0, "C")

tab4_col002_label = tk.Label(tab4, text="作业")
tab4_col002_label.grid(row=1, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col012_label = tk.Label(tab4, text="时间（分钟）")
tab4_col012_label.grid(row=1, column=4, padx=10, pady=1, sticky=tk.W)
tab4_col21_label = tk.Label(tab4, text="C廊桥检查及准备工作完成时间", wraplength=140, justify="left")
tab4_col21_label.grid(row=2, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col21_entry = tk.Entry(tab4, width=10)
tab4_col21_entry.grid(row=2, column=4, padx=10, pady=1, sticky=tk.W)

#可以设置frame
tab4_col1b_button1 = tk.Button(tab4, text="读取数据", command=readcsv)
tab4_col1b_button1.grid(row=13, column=2, padx=10, pady=1, sticky=tk.W)
tab4_col1b_label = tk.Label(tab4, text="目标\n航班序号", wraplength=140)
tab4_col1b_label.grid(row=13, column=3, padx=10, pady=1, sticky=tk.W)
tab4_col1b_entry = tk.Entry(tab4, width=10)
tab4_col1b_entry.grid(row=13, column=4, padx=10, pady=1, sticky=tk.W)
...
tab4_col1c_button2.grid(row=14, column=2, padx=10, pady=1, sticky=tk.W, columnspan=2)
tab4_col1c_entry = tk.Entry(tab4, width=10)
tab4_col1c_entry.grid(row=14, column=4, padx=10, pady=1, sticky=tk.W)
